...
var filter = false, sortOrder = 'Desc', sortColumn = 'UpdatedOn';
paging.pageSize = 12;
...
function Paging(sender) {
    ...
    AjaxFormSubmit({
        ...
        data: { page_no: paging.startIndex, per_page_result: paging.pageSize, sortColumn: sortColumn, sortOrder: sortOrder, buyer: Isbuyer,draft:isDraft },
        messageControl: null,
        throbberPosition: { my: "left center", at: "right center", of: sender, offset: "5 0" },
        url: '/Shops/RequestListingByBuyerOrSellerIDPaging',
